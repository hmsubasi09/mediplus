...
export default function RandevuTipleriLayout({ children }: LayoutProps) {
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link 
                href="/randevu-al" 
                className={`font-medium ${pathname.includes('/randevu-al') ? 'text-[#A6112B]' : 'text-gray-700'} hover:text-[#BD2640] font-['Work_Sans']`}
              >
                Randevu Al
              </Link>
              <Link 
