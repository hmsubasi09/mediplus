...
export default function RandevuAlLayout({ children }: LayoutProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 bg-white shadow-md">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white px-2 pt-2 pb-4 shadow-lg">
            ...
            <Link href="/randevu-al" className="block py-2 px-4 text-[#A6112B] font-medium font-['Work_Sans']">
              Randevu Al
            </Link>
            <Link href="/randevularim" className="block py-2 px-4 text-gray-700 hover:text-[#BD2640] font-['Work_Sans']">
              Randevularım
            </Link>
             <Link href="/profil" className="block py-2 px-4 text-gray-700 hover:text-[#BD2640] font-['Work_Sans']">
              Profil
            </Link>
      ...
      {/* Başlık Bölümü - Sayfaya göre değişebilir, ancak temel stil aynı */}
      <section className="bg-gradient-to-r from-[#A6112B] to-[#BD2640] py-8">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-2 font-['Yeseva_One']">
            {pathname === '/randevu-al' ? 'Online Randevu Al' : 
             pathname === '/randevu-al/tipler' ? 'Randevu Tipini Seçin' : 
             'Randevu İşlemleri'}
          </h1>
          <p className="text-lg text-white mb-4 font-['Work_Sans']">
            {pathname === '/randevu-al' ? 'Sağlığınız için en uygun zamanı seçin, uzman doktorlarımızla tanışın.' : 
             pathname === '/randevu-al/tipler' ? 'İhtiyacınıza uygun randevu tipini seçerek devam edin' : 
             'MediPlus sağlık hizmetleri her zaman yanınızda'}
          </p>
        </div>
      </section>
