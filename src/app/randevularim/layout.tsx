...
export default function RandevularimLayout({ children }: LayoutProps) {
      ...
      <header className="sticky top-0 z-50 bg-white shadow-md">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white px-2 pt-2 pb-4 shadow-lg">
            ...
            <Link href="/randevularim" className="block py-2 px-4 text-[#A6112B] font-medium font-['Work_Sans']">
              Randevularım
            </Link>
      ...
      <section className="bg-gradient-to-r from-[#A6112B] to-[#BD2640] py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-white mb-4 font-['Work_Sans']">
            Tüm randevularınızı görüntüleyin, düzenleyin veya iptal edin
          </p>
        </div>
      </section>
